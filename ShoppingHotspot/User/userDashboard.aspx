<%@ Page Title="Shopping Hotspot-User" Language="C#" MasterPageFile="~/User/userMaster.Master" AutoEventWireup="true" CodeBehind="userDashboard.aspx.cs" Inherits="ShoppingHotspot.User.userDashboard" %>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 col-md-12">
                        <div class="account-box">
                            <div class="service-box">
                                <div class="service-icon">
                                    <a href="profile.aspx"><i class="fa fa-lock"></i> </a>
                                </div>
                                <div class="service-desc">
                                    <h4>Your Profile</h4>
                    ...
                    <div class="col-lg-4 col-md-12">
                        <div class="account-box">
                            <div class="service-box">
                                <div class="service-icon">
                                    <a href="updateAddress.aspx"> <i class="fa fa-location-arrow"></i> </a>
                                </div>
                                <div class="service-desc">
                    ...
                    <div class="col-lg-4 col-md-12">
                        <div class="account-box">
                            <div class="service-box">
                                ...
                                <div class="service-desc">
                                    <h4>Your Services</h4>
                                    <p>Check your Services Status here.</p>
                                </div>
                            </div>
                        </div>
                    </div>
