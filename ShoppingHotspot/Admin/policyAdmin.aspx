<%@ Page Title="Shopping Hotspot-Admin Policy" Language="C#" MasterPageFile="~/Admin/AdminMaster.Master" AutoEventWireup="true" CodeBehind="policyAdmin.aspx.cs" Inherits="ShoppingHotspot.Admin.policyAdmin" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div id="page-wrapper">
        <div class="container-fluid">
            <h1 class="syzColor">Private Policy</h1>
            <p class="fntcolor">Add policy Here</p>
            <hr/>
            <div class="form-group">
                <table>
                    ...
                    <tr>
                        <td>
                            <asp:Label ID="lblpvtPolicy" CssClass="fntcolor" runat="server" Text="Policy:"></asp:Label>
                            <asp:TextBox TextMode="multiline" Columns="50" Rows="10" ID="txtpvtPolicy" runat="server" CssClass="form-control" placeholder="Enter info"></asp:TextBox>
                            <asp:RequiredFieldValidator ID="rfvpvtPolicy" runat="server"
                                ErrorMessage=" info to be added required" ControlToValidate="txtpvtPolicy" ForeColor="Red" ValidationGroup="User">
                            </asp:RequiredFieldValidator>
                        </td>
                    </tr>
            ...
            <asp:Button ID="btnpvtPolicy" runat="server" Text="Add policy" CssClass="btn btn-primary" OnClick="btnAddpvtPolicy_Click" ValidationGroup="User" />
                ...
                <div class="col-sm-12">
                    <div class="white-box">
                        ...
                        <div class="table-responsive">
                            ...
                            <asp:GridView ID="GrdpvtPolicy" AllowPaging="true" OnPageIndexChanging="GrdpvtPolicy_PageIndexChanging" class="table" AutoGenerateColumns="false" runat="server" PageSize="10" DataKeyNames="Id" OnRowCommand="GrdpvtPolicy_RowCommand" AllowSorting="True">
                                <Columns>
