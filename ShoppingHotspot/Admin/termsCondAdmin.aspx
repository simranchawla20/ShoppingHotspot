<%@ Page Title="Shopping Hotspot-Admin TermConditions" Language="C#" MasterPageFile="~/Admin/AdminMaster.Master" AutoEventWireup="true" CodeBehind="termsCondAdmin.aspx.cs" Inherits="ShoppingHotspot.Admin.termsCondAdmin" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div id="page-wrapper">
        <div class="container-fluid">
            <h1 class="syzColor">Terms And Condition</h1>
            <p class="fntcolor">Write Here</p>
            <hr/>
            <div class="form-group">
                <table>
                    ...
                    <tr>
                        <td>
                            <asp:Label ID="lblTermsCond" CssClass="fntcolor" runat="server" Text="terms and conditions:" ></asp:Label>
                            <asp:TextBox TextMode="multiline" Columns="50" Rows="10" ID="txtTermsCond" runat="server" CssClass="form-control" placeholder="Enter here"></asp:TextBox>
                            <asp:RequiredFieldValidator ID="rfvTermsCond" runat="server"
                                ErrorMessage=" something is required in textbox" ControlToValidate="txtTermsCond" ForeColor="Red" ValidationGroup="User">
                            </asp:RequiredFieldValidator>
                        </td>
                    </tr>
                  <%-- //...............................column1--%>
            ...
            <asp:Button ID="btnTermsCond" runat="server" Text="Add" CssClass="btn btn-primary" OnClick="btnAddTermsCond_Click" ValidationGroup="User" />
                ...
                <div class="col-sm-12">
                    <div class="white-box">
                        ...
                        <div class="table-responsive">
                            ...
                            <asp:GridView ID="GrdTermsCond" AllowPaging="true" OnPageIndexChanging="GrdTermsCond_PageIndexChanging" class="table" AutoGenerateColumns="false" runat="server" PageSize="10" DataKeyNames="Id" OnRowCommand="GrdTermsCond_RowCommand" AllowSorting="True">
                                <Columns>
                                    <asp:BoundField DataField="Id" HeaderText="ID"></asp:BoundField>
                                    <asp:BoundField DataField="title" HeaderText="Title"></asp:BoundField>
                                    <asp:BoundField DataField="termsAndCond" HeaderText="Terms And Conditions"></asp:BoundField>
